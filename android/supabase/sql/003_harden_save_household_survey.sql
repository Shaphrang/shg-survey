...
begin
  ...
  select
    ...
    nullif(trim(e->>'shg_name'), ''),
    nullif(trim(e->>'relationship_to_hof_other'), ''),
    nullif(trim(e->>'shg_code'), ''),
    nullif(trim(e->>'special_group'), ''),
    coalesce((e->>'is_job_card_holder')::boolean, false),
    nullif(trim(e->>'job_card_code'), ''),
    coalesce((e->>'is_pmayg')::boolean, false),
    nullif(trim(e->>'pmayg_code'), ''),
